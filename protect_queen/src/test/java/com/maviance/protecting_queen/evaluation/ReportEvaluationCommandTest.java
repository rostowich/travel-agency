...
public class ReportEvaluationCommandTest {
	...
	public void testEvaluationCommand(){
		...
		//We test the method
		ReportCommandEvaluation reportCommandEvaluation=new ReportCommandEvaluation();
		currentEvaluation=reportCommandEvaluation.evaluateCommand(currentEvaluation, command);

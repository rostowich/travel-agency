...
public class LeftCommandEvaluationTest {
	...
	public void testEvaluationCommand(){
		...
		String command="LEFT";
		//We test the method
		LeftCommandEvaluation leftCommandEvaluation=new LeftCommandEvaluation();
		currentEvaluation=leftCommandEvaluation.evaluateCommand(currentEvaluation, command);
		...
		assertThat(currentEvaluation.getPosition().getDirection()).isEqualTo(Direction.WEST);
	}

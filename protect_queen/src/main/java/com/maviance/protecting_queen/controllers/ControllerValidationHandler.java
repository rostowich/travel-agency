...
import com.maviance.protecting_queen.domain.MessageDTO;
import com.maviance.protecting_queen.domain.MessageType;



/**
 * This class is a controller advice that will intercept exceptions of a specific kind
 * and return something else. It return a MessageDTO object with the type and the message of the error
